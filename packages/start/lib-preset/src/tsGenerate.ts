...
import plugin, { StartFile, StartPlugin, StartDataFile, StartDataFilesProps } from '@start/plugin'

// https://github.com/Microsoft/TypeScript/wiki/Using-the-Compiler-API
export default function tsGenerate(
  compilerOptions?: Partial<ts.CompilerOptions>,
): StartPlugin<StartDataFilesProps, StartDataFilesProps> {
  return plugin('tsGenerate', ({ logPath }) => async ({ files }: StartDataFilesProps) => {
