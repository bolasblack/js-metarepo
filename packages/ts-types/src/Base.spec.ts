...
describe('Base', () => {
  ...
  it('can specify the result type', () => {
    expectTypeOf<
      Equals<string, string, 'true', 'false'>
    >().toEqualTypeOf<'true'>()
    expectTypeOf<
      Equals<string, number, 'true', 'false'>
    >().toEqualTypeOf<'false'>()
    expectTypeOf<
      Equals<'a' | 'b', 'a' | 'b', 'true', 'false'>
    >().toEqualTypeOf<'true'>()
    expectTypeOf<
      Equals<'a' | 'b', 'a' | 'c', 'true', 'false'>
    >().toEqualTypeOf<'false'>()
    expectTypeOf<
      Equals<string[], string[], 'true', 'false'>
    >().toEqualTypeOf<'true'>()
    ...
    >().toEqualTypeOf<'false'>()
    expectTypeOf<
      Equals<any[], Array<[number]>, 'true', 'false'>
    >().toEqualTypeOf<'false'>()
    expectTypeOf<
      Equals<any[], unknown[], 'true', 'false'>
    >().toEqualTypeOf<'false'>()
    expectTypeOf<
